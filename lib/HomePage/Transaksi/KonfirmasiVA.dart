...
import 'package:flutter_application_2/HomePage/Transaksi/SuksesVA.dart';
import 'package:flutter_application_2/HomePage/Transaksi/Transaksi.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: new GestureDetector(
                onTap: () => {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => SuksesVA())),
                },
                child: Container(
                  width: 100,
                  height: 40,
